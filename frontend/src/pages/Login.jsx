// ============================================================
// LOGIN PAGE — Save as: frontend/src/pages/Login.jsx
// ============================================================
    ...
    <div style={{ minHeight: '100vh', background: '#f7f9fc', display: 'flex', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      <div style={{ width: '45%', background: 'linear-gradient(160deg, #1a3c2e 0%, #2d6a4f 50%, #40916c 100%)', padding: '48px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <div>
          <h2 style={{ fontSize: '36px', fontWeight: '800', color: '#fff', fontFamily: 'Georgia, serif', lineHeight: '1.3', marginBottom: '20px' }}>
            Your health journey,<br />beautifully organized
          </h2>
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.7)', lineHeight: '1.7', marginBottom: '40px' }}>
            Track symptoms, scan prescriptions, and get AI-powered doctor summaries — all in one place.
          </p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {['AI-generated doctor summaries', 'Prescription OCR scanning', 'Medicine reminders & tracking'].map(f => (
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px' }}>
        <div style={{ width: '100%', maxWidth: '400px' }}>
          <h1 style={{ fontSize: '28px', fontWeight: '800', color: '#1a2332', fontFamily: 'Georgia, serif', marginBottom: '8px' }}>Welcome back</h1>
          <p style={{ fontSize: '14px', color: '#718096', marginBottom: '32px' }}>Sign in to your RxRecall account</p>
          ...
          <p style={{ textAlign: 'center', fontSize: '13px', color: '#718096', marginTop: '24px' }}>
            ...
            <Link to="/signup" style={{ color: '#2d6a4f', fontWeight: '600', textDecoration: 'none' }}>Create one free</Link>
          </p>
        </div>
      </div>
    </div>
...
// ============================================================
// SIGNUP PAGE — Save as: frontend/src/pages/Signup.jsx
// ============================================================

// Copy the Login component above and make these changes:
// 1. Change handleSubmit to call: api.post('/auth/signup', form)
// 2. Add "name" field to form state and add a Name input above email
// 3. Change heading to "Create your account"
// 4. Change button text to "Create Account"
// 5. Change bottom link to: Already have account? Log in